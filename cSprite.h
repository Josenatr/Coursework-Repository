...
public:
	...
	~cSprite();			// Destructor
	void render(SDL_Renderer* theRenderer, SDL_Rect* theSourceRect, SDL_Rect* theDestRect, SDL_Point theScaling);
	void render(SDL_Renderer* theRenderer, SDL_Rect* theSourceRect, SDL_Rect* theDestRect, double rotAngle, SDL_Point* spriteCentre, SDL_Point theScaling);
	...
	SDL_Point getSpriteScale();  // Return the sprites scaling factor
	void setSpriteScale(SDL_Point sScale); // set the sprites scaling factor
